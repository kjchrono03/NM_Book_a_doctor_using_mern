...
const UserAppointments = () => {
  ...
  const getUser = () => {
    ...
    if (user) {
      ...
      // Fetch appointments immediately after setting user ID and type
      if (isdoctor) {
  ...
  const getUserAppointment = async (id) => {
    try {
      ...
      console.log(error);
      message.error('Unable to fetch user appointments');
    }
  };
  ...
  const getDoctorAppointment = async (id) => {
    try {
      ...
      console.log(error);
      message.error('Unable to fetch doctor appointments');
    }
  };
  ...
  const handleDownload = async (url, appointId) => {
    try {
      ...
      console.log(error);
      message.error('Unable to download document');
    }
  };
